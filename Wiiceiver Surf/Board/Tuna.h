...
void do_ui() {
  ...
  Serial.println(F("Max throttle: 0-100%"));
  ui_getThrottle(2, EEPROM_MAXTHROTTLE_ADDY, 1, 100);
  Serial.println(F("Auto cruise: 0-100%"));
  ui_getThrottle(3, EEPROM_AUTOCRUISE_ADDY, 1, 0);
  Serial.println(F("Drag brake: 0-100%"));
  ui_getThrottle(4, EEPROM_DRAGBRAKE_ADDY, -1, 0);
  Serial.print(F("Acceleration profile: 1-6, 3 = default"));
